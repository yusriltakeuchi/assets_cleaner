...
class AssetServices {
  ...
  List<String> _removeExcludedExt(List<String> excludedExtensions, List<String> value) {
  ...
  List<String> _removeExcludedFile(List<String> excludedFiles, List<String> value) {
